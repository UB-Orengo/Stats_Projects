...
ads_2_log_density <- ggdensity(ads_2_log, x = "Product_Price", fill = "lightgray", title = "Product Price, Health & Household, Normalized") +
                     stat_overlay_normal_density(color = "red", linetype = "dashed")
...
ads_3_log_density <- ggdensity(ads_3_log, x = "Product_Price", fill = "lightgray", title = "Product Price, Beauty & Personal Care, Normalized") +
  stat_overlay_normal_density(color = "red", linetype = "dashed")
...
ads_4_log_density <- ggdensity(ads_4_log, x = "Product_Price", fill = "lightgray", title = "Product Price, Tools & Home Improvement, Normalized") +
  stat_overlay_normal_density(color = "red", linetype = "dashed")
...
ads_5_log_density <- ggdensity(ads_5_log, x = "Product_Price", fill = "lightgray", title = "Product Price, Toys & Games, Normalized") +
  stat_overlay_normal_density(color = "red", linetype = "dashed")
...
ads_6_log_density <- ggdensity(ads_6_log, x = "Product_Price", fill = "lightgray", title = "Product Price, Baby Products, Normalized") +
  stat_overlay_normal_density(color = "red", linetype = "dashed")
...
ads_7_log_density <- ggdensity(ads_7_log, x = "Product_Price", fill = "lightgray", title = "Product Price, Office Products, Normalized") +
  stat_overlay_normal_density(color = "red", linetype = "dashed")
...
ads_9_log_density <- ggdensity(ads_9_log, x = "Product_Price", fill = "lightgray", title = "Product Price, Clothing, Shoes & Jewelry, Normalized") +
  stat_overlay_normal_density(color = "red", linetype = "dashed")
...
- Standard Error     0.00350016259798728
...
- Standard Error     0.00589861043335116
...
- Standard Error         0.0048123119459761
...
- Standard Error           0.0120494878343595
...
- Standard Error     0.0129097738108929
...
- Standard Error     0.0156168918806012
...
- Standard Error            0.0193625233105732

# PART B - CONFIDENCE INTERVAL/HYPOTHESIS TESTING

# PART 6 - PERFORMING CONFIDENCE INTERVAL TESTING

- DETERMINE HOW STATISTICALLY CLOSE THE SAMPLE MEAN IS TO THE POPULATION MEAN AND WHETHER OR NOT THE DIFFERENCE BETWEEN THE MEANS OF EACH PRODUCT CATEGORY IS STATISTICALLY SIGNIFICANT
...
<img src="EDA_STATS_HTML_files\figure-html\unnamed-chunk-139-1.png"  height="400" width="870">

## CONFIDENCE INTERVAL PLOT -- 99% CONFIDENCE

<img src="EDA_STATS_HTML_files\figure-html\unnamed-chunk-139-2.png"  height="400" width="927">


## MOVE FORWARD WITH THE DATAFRAMES THAT HAVE THE SMALLEST GAP BETWEEN THE LOWER/UPPER BOUND FOR THE MEAN WITH THE HIGHEST COUNTS, TO COMPARE IF THE DIFFERENCE IS STATISTICALLY SIGNIFICANT
...
## THERE IS A SIGNIFICANT DIFFERENCE BETWEEN THE VARIANCE OF THE TWO POPULATION MEANS between 1&2, 1&3, and 2&3
...
- P.VALUE FOR MEANS 1 AND 2, MEANS 2 AND 3, AND MEANS 1,3 are > THAN ALPHA
